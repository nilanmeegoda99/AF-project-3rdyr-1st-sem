                        ...
                        <ul className="navbar-nav ms-auto mb-2 mb-lg-0">
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><Link className="dropdown-item" to="/research/instructions">Instructions</Link></li>
                                    <li><Link className="dropdown-item" to="/research/published">Publications</Link></li>
                            ...
                            <li className="nav-item dropdown">
                                ...
                                <ul className="dropdown-menu" aria-labelledby="navbarDropdown">
                                    <li><Link className="dropdown-item" to="/attendee/instructions">Instructions</Link></li>

                                    { this.state.user.user_type == "Attendee" &&
                                        <>
                                            <li><hr className="dropdown-divider" /></li>
                                            <li><Link className="dropdown-item" to="/attendee/my">My Activity</Link></li>
                                        </>
                                    }
                                </ul>
                            </li>
                            ...
                            :
                                <div className="d-flex">
                                    <button className="btn btn-outline-success btn-sm" onClick={this.redirectToLogin}>
                                        Login
                                    </button>
                                </div>
                            }
